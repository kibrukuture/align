...
Get started with the Align SDK in your TypeScript or JavaScript project.
...
<Tabs>
  <Tab title="npm">```bash npm install @tolbel/align ```</Tab>
  <Tab title="yarn">```bash yarn add @tolbel/align ```</Tab>
  <Tab title="pnpm">```bash pnpm add @tolbel/align ```</Tab>
  <Tab title="bun">```bash bun add @tolbel/align ```</Tab>
</Tabs>
...
<Tabs>
  <Tab title="Node.js">```bash npx tsx test.ts ```</Tab>
  <Tab title="Bun">```bash bun run test.ts ```</Tab>
</Tabs>
