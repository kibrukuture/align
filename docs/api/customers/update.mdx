...
Upload documents to a customer's profile for KYC verification. This is typically used to submit identity documents and proof of address.
...
| `selfie`            | Photo of customer holding their ID                    | JPEG, PNG        |
| `incorporation_doc` | Business incorporation documents (for corporates)     | PDF              |
