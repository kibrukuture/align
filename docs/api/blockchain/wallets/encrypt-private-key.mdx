...
Encrypt a wallet's private key using a password for secure storage. The encrypted output follows the standard Ethereum keystore format (Web3 Secret Storage).
