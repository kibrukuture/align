...
Restore a cryptocurrency wallet from an existing mnemonic (seed phrase). This is useful for recovering wallets or generating deterministic wallet hierarchies.
