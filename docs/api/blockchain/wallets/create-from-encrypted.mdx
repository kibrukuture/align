...
# Create Wallet from Encrypted

Decrypt and restore a wallet from an encrypted JSON keystore file. This is compatible with standard Ethereum keystore format (Web3 Secret Storage).
