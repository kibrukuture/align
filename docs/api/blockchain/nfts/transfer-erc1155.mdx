...
Transfer ERC-1155 tokens (semi-fungible or multi-tokens) to another address. ERC-1155 supports both fungible and non-fungible tokens in a single contract.
