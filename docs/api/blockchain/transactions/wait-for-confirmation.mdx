...
Block execution until a transaction reaches the specified number of confirmations. Essential for ensuring transaction finality before proceeding with dependent operations.
