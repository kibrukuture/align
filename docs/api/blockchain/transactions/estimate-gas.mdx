...
Calculate the gas cost for a transaction before sending it. This helps users understand the fee they'll pay and prevents failed transactions due to insufficient gas.
