...
<Tabs>
  <Tab title="Blockchain Networks">
    | Network | Chain ID | Status | |---------|----------|--------| | Ethereum |
    1 | ✅ Mainnet | | Polygon | 137 | ✅ Mainnet | | Base | 8453 | ✅ Mainnet |
    | Arbitrum | 42161 | ✅ Mainnet | | Solana | - | ✅ Mainnet | | Tron | - |
    ✅ Mainnet |
  </Tab>
  <Tab title="Stablecoins">
    | Token | Networks | |-------|----------| | USDC | Ethereum, Polygon, Base,
    Arbitrum, Solana | | USDT | Ethereum, Polygon, Tron | | EURC | Ethereum,
    Polygon |
  </Tab>
  <Tab title="Fiat Currencies">
    | Currency | Payment Rails | |----------|---------------| | USD | ACH, Wire
    | | EUR | SEPA, SWIFT | | AED | UAEFTS |
  </Tab>
</Tabs>
