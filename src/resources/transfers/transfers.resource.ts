...
export class TransfersResource {
   ...
   * ```
   */
  public async createOfframpQuote(
    customerId: string,
    ...
    if (!validation.success) {
      throw new AlignValidationError(
        "Invalid offramp quote data",
        formatZodError(validation.error)
      );
    }

    return this.client.post<QuoteResponse>(
      TRANSFER_ENDPOINTS.OFFRAMP_QUOTE(customerId),
      data
    );
  }
   ...
   * ```
   */
  public async createOnrampQuote(
    customerId: string,
    ...
    if (!validation.success) {
      throw new AlignValidationError(
        "Invalid onramp quote data",
        formatZodError(validation.error)
      );
    }

    return this.client.post<QuoteResponse>(
      TRANSFER_ENDPOINTS.ONRAMP_QUOTE(customerId),
      data
    );
  }
   ...
   * ```
   */
  public async createOfframpTransfer(
    customerId: string,
    quoteId: string,
    ...
    return this.client.post<Transfer>(
      TRANSFER_ENDPOINTS.OFFRAMP_CREATE(customerId, quoteId),
      data
    );
  }
   ...
   * ```
   */
  public async completeOfframpTransfer(
    customerId: string,
    transferId: string,
    ...
    return this.client.post<Transfer>(
      TRANSFER_ENDPOINTS.OFFRAMP_COMPLETE(customerId, transferId),
      data
    );
  }
   ...
   * ```
   */
  public async createOnrampTransfer(
    customerId: string,
    quoteId: string,
    ...
    if (!validation.success) {
      throw new AlignValidationError(
        "Invalid onramp transfer data",
        formatZodError(validation.error)
      );
    }

    return this.client.post<Transfer>(
      TRANSFER_ENDPOINTS.ONRAMP_CREATE(customerId, quoteId),
      data
    );
  }
   ...
   * ```
   */
  public async getOfframpTransfer(
    customerId: string,
    transferId: string
  ): Promise<Transfer> {
    return this.client.get<Transfer>(
      TRANSFER_ENDPOINTS.OFFRAMP_GET(customerId, transferId)
    );
  }
   ...
   * ```
   */
  public async getOnrampTransfer(
    customerId: string,
    transferId: string
  ): Promise<Transfer> {
    return this.client.get<Transfer>(
      TRANSFER_ENDPOINTS.ONRAMP_GET(customerId, transferId)
    );
  }
   ...
   * ```
   */
  public async listOfframpTransfers(
    customerId: string
  ): Promise<TransferListResponse> {
    return this.client.get<TransferListResponse>(
      TRANSFER_ENDPOINTS.OFFRAMP_LIST(customerId)
    );
  }
   ...
   * ```
   */
  public async listOnrampTransfers(
    customerId: string
  ): Promise<TransferListResponse> {
    return this.client.get<TransferListResponse>(
      TRANSFER_ENDPOINTS.ONRAMP_LIST(customerId)
    );
  }
   ...
   * ```
   */
  public async simulateOfframpTransfer(
    customerId: string,
    ...
    return this.client.post<SimulateTransferResponse>(
      TRANSFER_ENDPOINTS.SIMULATE(customerId),
      data
    );
  }
   ...
   * ```
   */
  public async simulateOnrampTransfer(
    customerId: string,
    ...
    return this.client.post<SimulateTransferResponse>(
      TRANSFER_ENDPOINTS.ONRAMP_SIMULATE(customerId),
      data
    );
  }
}
