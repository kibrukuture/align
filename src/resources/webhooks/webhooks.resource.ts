...
export class WebhooksResource {
  constructor(private client: HttpClient, private apiKey?: string) {}
  ...
  public verifySignature(
    ...
    const resolvedSecret = secret ?? this.apiKey;
    if (!resolvedSecret) {
      throw new Error("Missing secret for webhook signature verification");
    }
